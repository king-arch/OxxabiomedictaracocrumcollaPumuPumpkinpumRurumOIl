...
var patient_details_alldata;
 ...
 Template.create_report_doctor_form.onRendered(function(){
...
setTimeout(function(){
 ...
 Template.create_report_doctor_form.helpers({
    ...
    show_dates(){
      ...
      Meteor.subscribe('get_user_info_doctor',active_user);
      var listing = doctor_details.find({doctor_id: active_user}).fetch();
      return listing;
      },
